...
int main(int argc, char **argv) {
  ...
  nh.param<float>("urimits/max_distSq_to_next_cone", urimits.max_distSq_to_next_cone, 5.2);
  ...
  nh.param<float>("urimits/max_percentage_most_coneHeur", urimits.max_percentage_most_coneHeur, 20.0);
